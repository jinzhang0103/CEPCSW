...
namespace Generic {
  ...
  inline void
  GenericDetectorElement::assignIdentifier(
      const Identifier& identifier)
  {
  ...
  inline Identifier
  Generic::GenericDetectorElement::identifier() const
  {
    return m_elementIdentifier;
  }

  inline const Acts::Transform3D&
  Generic::GenericDetectorElement::transform(
  ...
  Generic::GenericDetectorElement::surface() const
  {
    return *m_elementSurface;
  }

  inline double
  Generic::GenericDetectorElement::thickness() const
  {
    return m_elementThickness;
  }

  inline const std::shared_ptr<const Acts::DigitizationModule>
  Generic::GenericDetectorElement::digitizationModule() const
  {
